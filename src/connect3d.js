 ...
 */
 const onSceneReady = (scene) => {
    ...
    const helper = scene.createDefaultEnvironment({
      ...
      groundTexture: require('../static/backgroundGround.png'),
    ...
    var links = {
        ...
        resume: require('../static/Varun Unnithan Resume.pdf'),
        devpost: 'https://devpost.com/varun-unnithan33',
        linkedin: 'https://www.linkedin.com/in/varun-unnithan'
    }

    SceneLoader.ImportMesh("","", require('../static/connect.babylon'), scene, function(newMeshes){
